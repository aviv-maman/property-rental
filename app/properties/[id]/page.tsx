...
const PropertyPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPropertyData = async () => {
      if (!id) return;
      try {
        const property = await fetchProperty(String(id));
                ...
                <main>
                  ...
                  <div className='bg-white p-6 rounded-lg shadow-md mt-6'>
                    ...
                    <div className='flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9'>
                      <p>
                        <i className='fa-solid fa-bed'></i> 3<span className='hidden sm:inline'>Beds</span>
                      </p>
                      <p>
                        <i className='fa-solid fa-bath'></i> 2<span className='hidden sm:inline'>Baths</span>
                      </p>
                      <p>
                    ...
                    <p className='text-gray-500 mb-4'>This is a beautiful apartment located near the commons</p>
                    <p className='text-gray-500 mb-4'>
                      We have a beautiful apartment located near the commons. It is a 2 bedroom apartment with a full kitchen and bathroom. It is
