...
const ProfilePage: React.FC = async () => {
  ...
  const properties = propertiesDocs.map(convertToSerializeableObject) as Property[];
        ...
        <div className='bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0'>
          ...
          <div className='flex flex-col md:flex-row'>
            ...
            <div className='md:w-3/4 md:pl-4'>
              ...
              {properties.length === 0 ? <p>You have no property listings</p> : <ProfileProperties properties={properties} />}
            </div>
          </div>
        </div>
      </div>
